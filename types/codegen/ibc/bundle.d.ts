    ...
    const ClientFactory: {
        ...
        createLCDClient: ({ restEndpoint }: {
            ...
            ibc: {
                applications: {
                    fee: {
                        v1: _367.LCDQueryClient;
                    };
                    interchain_accounts: {
                        controller: {
                            v1: _368.LCDQueryClient;
                        };
                        host: {
                            v1: _369.LCDQueryClient;
                        };
                    };
                    transfer: {
                        v1: _370.LCDQueryClient;
                    };
                };
                core: {
                    channel: {
                    ...
                    client: {
                        v1: _372.LCDQueryClient;
                    };
                    connection: {
                        v1: _373.LCDQueryClient;
                    };
                };
            };
        }>;
