...
import { Long, isSet, toTimestamp, toDuration, fromTimestamp, fromDuration, bytesFromBase64, fromJsonTimestamp, base64FromBytes } from "../../../../helpers";
...
export const IndexValue = {
  ...
  encode(message: IndexValue, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.duration !== undefined) {
      Duration.encode(toDuration(message.duration), writer.uint32(66).fork()).ldelim();
    }
    return writer;
  },
