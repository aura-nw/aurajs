...
export const EventRegisterRevenue = {
  ...
  toJSON(message: EventRegisterRevenue): unknown {
    const obj: any = {};
...
export const EventUpdateRevenue = {
  ...
  toJSON(message: EventUpdateRevenue): unknown {
    const obj: any = {};
    message.contractAddress !== undefined && (obj.contractAddress = message.contractAddress);
    message.deployerAddress !== undefined && (obj.deployerAddress = message.deployerAddress);
...
export const EventCancelRevenue = {
  ...
  toJSON(message: EventCancelRevenue): unknown {
    const obj: any = {};
    message.deployerAddress !== undefined && (obj.deployerAddress = message.deployerAddress);
    message.contractAddress !== undefined && (obj.contractAddress = message.contractAddress);
    return obj;
...
export const EventDistributeRevenue = {
  ...
  toJSON(message: EventDistributeRevenue): unknown {
    const obj: any = {};
