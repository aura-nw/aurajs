...
export const QueryRevenuesRequest = {
  ...
  toJSON(message: QueryRevenuesRequest): unknown {
    const obj: any = {};
...
export const QueryRevenuesResponse = {
  ...
  toJSON(message: QueryRevenuesResponse): unknown {
    const obj: any = {};
    if (message.revenues) {
...
export const QueryRevenueRequest = {
  ...
  toJSON(message: QueryRevenueRequest): unknown {
    const obj: any = {};
...
export const QueryRevenueResponse = {
  ...
  toJSON(message: QueryRevenueResponse): unknown {
    const obj: any = {};
...
export const QueryDeployerRevenuesRequest = {
  ...
  toJSON(message: QueryDeployerRevenuesRequest): unknown {
    const obj: any = {};
...
export const QueryDeployerRevenuesResponse = {
  ...
  toJSON(message: QueryDeployerRevenuesResponse): unknown {
    const obj: any = {};
...
export const QueryWithdrawerRevenuesRequest = {
  ...
  toJSON(message: QueryWithdrawerRevenuesRequest): unknown {
    const obj: any = {};
...
export const QueryWithdrawerRevenuesResponse = {
  ...
  toJSON(message: QueryWithdrawerRevenuesResponse): unknown {
    const obj: any = {};
    if (message.contractAddresses) {
      obj.contractAddresses = message.contractAddresses.map(e => e);
    } else {
