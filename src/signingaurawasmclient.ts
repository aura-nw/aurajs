...
import {auraWasmTypes} from './aminotypes';
...
function createDefaultRegistry(): Registry {
  ...
  return new Registry([
    ...defaultRegistryTypes,
    ['/auranw.aura.wasm.MsgClearAdmin', MsgClearAdmin],
    ['/auranw.aura.wasm.MsgExecuteContract', MsgExecuteContract],
    ['/auranw.aura.wasm.MsgMigrateContract', MsgMigrateContract],
    ['/auranw.aura.wasm.MsgStoreCode', MsgStoreCode],
    ['/auranw.aura.wasm.MsgInstantiateContract', MsgInstantiateContract],
    ['/auranw.aura.wasm.MsgUpdateAdmin', MsgUpdateAdmin],
  ]);
}

export interface SigningAuraWasmClientOptions {
...
export class SigningAuraWasmClient extends AuraWasmClient {
  ...
  public static async connectWithSigner(
    ...
    options: SigningAuraWasmClientOptions = {},
  ): Promise<SigningAuraWasmClient> {
    const tmClient = await Tendermint34Client.connect(endpoint);
    return new SigningAuraWasmClient(tmClient, signer, options);
  }
  ...
  public static async offline(
    ...
    return new SigningAuraWasmClient(undefined, signer, options);
  }
  ...
  protected constructor(
    ...
    const {
      ...
      aminoTypes = new AminoTypes({additions: auraWasmTypes, prefix: options.prefix}),
    } = options;
  ...
  public async updateAdmin(
    ...
    const updateAdminMsg: MsgUpdateAdminEncodeObject = {
      typeUrl: '/auranw.aura.wasm.MsgUpdateAdmin',
  ...
  public async clearAdmin(
    ...
    const clearAdminMsg: MsgClearAdminEncodeObject = {
      typeUrl: '/auranw.aura.wasm.MsgClearAdmin',
  ...
  public async migrate(
    ...
    const migrateContractMsg: MsgMigrateContractEncodeObject = {
      typeUrl: '/auranw.aura.wasm.MsgMigrateContract',
  ...
  public async execute(
    ...
    const executeContractMsg: MsgExecuteContractEncodeObject = {
      typeUrl: '/auranw.aura.wasm.MsgExecuteContract',
